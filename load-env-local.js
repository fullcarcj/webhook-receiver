 ...
 * CRM_WA_WELCOME_ENABLED=1: tras el primer mensaje inbound guardado, Wasender envía saludo con nombre/apellido si el cliente ya tiene nombre válido en CRM; si no, pide nombre y apellido (columna crm_chats.wa_welcome_sent_at; migración npm run db:crm-wa-welcome). Plantillas opcionales: CRM_WA_WELCOME_GREETING ({{nombre}}), CRM_WA_WELCOME_ASK_NAME (default en código: bienvenida Solomotor3k + pedir nombre y apellido).
