 ...
 * AI Responder (piloto WhatsApp): AI_RESPONDER_ENABLED=1 activa cola + worker (src/workers/aiResponderWorker.js, ciclo 5s); AI_RESPONDER_CONFIDENCE_MIN (default 85). Migración sql/20260411_ai_responder.sql → npm run db:ai-responder; comprobar esquema: npm run verify:ai-responder. Monitoreo HTML: GET /ai-responder?k= (ADMIN_SECRET); API JSON bajo /api/ai-responder/* con ensureAdmin. Requiere GROQ (provider_settings GROQ_LLAMA o GROQ_API_KEY) y WASENDER_API_KEY para envío.
