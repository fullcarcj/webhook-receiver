 ...
 * AI Responder — **Tipo M** (piloto WhatsApp CRM): mensaje = plantilla `AI_RESPONDER_GENERIC_TEMPLATE` (placeholders {{CONTEXTO_IA}}, {{NOMBRE}}, {{NOMBRE_SALUDO}}) + línea contextual vía GROQ (`context_line`; la IA no elige flujo). AI_RESPONDER_ENABLED=1 activa cola + worker; AI_RESPONDER_CONFIDENCE_MIN queda solo referencia en stats. Migración npm run db:ai-responder; verify: npm run verify:ai-responder. Monitoreo GET /ai-responder?k=. GROQ + WASENDER_API_KEY.
