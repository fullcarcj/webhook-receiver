 ...
 * customers.name_suggested: último pushName del webhook Wasender (messages.js); solo referencia futura, no usado en resolveCustomer ni CRM WA. Migración: npm run db:customers-name-suggested.
